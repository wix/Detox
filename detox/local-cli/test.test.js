...
jest.mock('../src/devices/drivers/android/genycloud/GenyCloudDeviceRegistry');
...
describe('CLI', () => {
  ...
  beforeEach(() => {
    ...
    GenyCloudDeviceRegistry = require('../src/devices/drivers/android/genycloud/GenyCloudDeviceRegistry');
    GenyCloudDeviceRegistry.forGlobalCleanup.mockImplementation(() => new DeviceRegistry());
  });
