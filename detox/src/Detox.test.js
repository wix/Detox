...
describe("Detox", () => {
	...
	const validDeviceConfigWithSession =
		schemes.sessionPerConfiguration.configurations["ios.sim.none"];
	const invalidDeviceConfig =
		schemes.invalidDeviceNoDeviceType.configurations["ios.sim.release"];
	const invalidDeviceTypeConfig =
		schemes.invalidOneDeviceTypeEmulatorNoSession.configurations[
			"ios.sim.release"
		];
