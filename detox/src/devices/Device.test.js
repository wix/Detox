...
const validIosNoneScheme = require("../configurations.mock")
  .validOneIosNoneDeviceNoSession;

const invalidDeviceNoBinary = require("../configurations.mock")
  .invalidDeviceNoBinary;
const invalidDeviceNoDeviceName = require("../configurations.mock")
