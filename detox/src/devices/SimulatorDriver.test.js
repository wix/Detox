...
describe('SimulatorDriver', () => {
  ...
  it(`setPermissions() should trigger applesimutils`, async() => {
    simulatorDriver = validSimulator();
    await simulatorDriver.setPermissions();
    expect(simulatorDriver._applesimutils.setPermissions).toHaveBeenCalledTimes(1);
  });
