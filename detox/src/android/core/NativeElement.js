...
class NativeElement {
  ...
  async tap(value) {
    ...
    return await new ActionInteraction(this._device, this, action, traceDescription).execute();
  }
  ...
  async takeScreenshot(screenshotName) {
    ...
    const resultBase64 = await new ActionInteraction(this._device, this, action, traceDescription).execute();
  ...
  async getAttributes() {
    ...
    const result = await new ActionInteraction(this._device, this, action, traceDescription).execute();
