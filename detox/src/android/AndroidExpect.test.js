  ...
  describe('native', () => {
    ...
    describe('element interactions', () => {
      it('should tap and long-press', async () => {
        ...
        await e.element(e.by.label('Tap Me')).longPress(1000, { x: 10, y: 10 });
      ...
      it('should not tap and long-press given bad args', async () => {
        ...
        await jestExpect(() => e.element(e.by.label('Tap Me')).longPress(1000, 'NaN')).rejects.toThrow();
        await jestExpect(() => e.element(e.by.label('Tap Me')).longPress(1000, { x: 'NaN', y: 10 })).rejects.toThrow();
        await jestExpect(() => e.element(e.by.label('Tap Me')).longPress(1000, { x: 10, y: 'NaN' })).rejects.toThrow();
      });
