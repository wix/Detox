...
class Matcher {
  withAncestor(matcher) {
    ...
    this._call = invoke.call(
      ...
      "detoxMatcherForBoth:andAncestorMatcher:",
  ...
  withDescendant(matcher) {
    ...
    this._call = invoke.call(
      invoke.IOS.Class("GREYMatchers"),
      "detoxMatcherForBoth:andDescendantMatcher:",
      _originalMatcherCall,
      matcher._call
    );
    return this;
...
class LabelMatcher extends Matcher {
  constructor(value) {
    ...
    this._call = invoke.call(
      invoke.IOS.Class("GREYMatchers"),
      "detox_matcherForAccessibilityLabel:",
      value
    );
  }
}
