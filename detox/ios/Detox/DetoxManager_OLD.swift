...
fileprivate let log = DetoxLog(category: "DetoxManager_OLD")

@objc(DTXDetoxManager_OLD)
public class DetoxManager_OLD : NSObject, WebSocketDelegate {
	private let webSocket : WebSocket
	private var isReady = false
	
	@objc(sharedManager)
	public static var shared : DetoxManager_OLD = {
		return DetoxManager_OLD()
	}()
