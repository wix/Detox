...
declare module 'detox' {
    export const device: Detox.DetoxExportWrapper['device'];
    export const element: Detox.DetoxExportWrapper['element'];
    export const waitFor: Detox.DetoxExportWrapper['waitFor'];
    export const expect: Detox.DetoxExportWrapper['expect'];
    export const by: Detox.DetoxExportWrapper['by'];
    export const init: Detox.DetoxExportWrapper['init'];
    export const beforeEach: Detox.DetoxExportWrapper['beforeEach'];
    export const afterEach: Detox.DetoxExportWrapper['afterEach'];
    export const cleanup: Detox.DetoxExportWrapper['cleanup'];

    export type DetoxConfig = Detox.DetoxConfig;
}
...
declare const detoxCircus: Detox.DetoxCircus;
