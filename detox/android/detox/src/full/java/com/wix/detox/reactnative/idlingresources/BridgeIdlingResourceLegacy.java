 ...
 * </p>
 */
public class BridgeIdlingResourceLegacy extends BridgeIdlingResource implements NotThreadSafeBridgeIdleDebugListener {
    ...
    BridgeIdlingResourceLegacy(ReactContext reactContext) {
