...
If your tests are failing due to non-existent or invisible elements, you can [inspect the native view hierarchy](test-id.md#find-your-testid) to understand better the failure reason.
