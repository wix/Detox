...
[`Using Genymotion SaaS`]: /guide/genymotion-saas
[`Config file > Test runner`]: /config/testRunner
[`Internals API`]: /api/internals
[`Dropping Mocha support`]: https://github.com/wix/Detox/issues/3193
[`Config file > Device`]: /config/devices
[`Config file > Logger`]: /config/logger
[`Config file > Test runner`]: /config/testRunner
[`Logger API`]: /api/logger
[reset-lock-file]: /cli/reset-lock-file
...
[Migration Guide]: /guide/migration#200
[Updating command-line scripts]: /guide/migration#updating-command-line-scripts
[Debugging Native]: /introduction/debugging#native-application-code
