...
| -a, --artifacts-location \<path\>             | Artifacts (logs, screenshots, etc) root directory. For more details, please check the [Enabling artifacts](APIRef.Artifacts.md#artifacts). The default value is **artifacts** folder. |
