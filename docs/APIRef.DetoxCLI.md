...
| --logger-show-date                            | When using Detox' custom logger, add dates to logs. Defaults to _true_. |
| --logger-show-logger-name                     | When using Detox' custom logger, add logger name to logs. Defaults to _true_. |
| --logger-show-pid                             | When using Detox' custom logger, add PID to logs. Defaults to _true_. |
| --logger-show-metadata                        | When using Detox' custom logger, add metadata to logs. Defaults to _false_. |
