...
| --optimize-apk-install                        | Uses an optimized method for installation where a hash is stored on the device allowing future app installation to be skipped when possible.<br />_Default: false_                                                                                                                                        |
| --help                                        | Show help                                                                                                                                                                                                                                                                                                 |
