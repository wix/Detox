...
Adjusting the session.debugSynchronization value to `0` or a higher value like `60000` can help disable or reduce the frequency of these logs respectively. For a deeper understanding of this setting's purpose, refer to the [How Detox Works](../articles/how-detox-works.md#how-detox-automatically-synchronizes-with-your-app) article.
