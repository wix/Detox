...
These issues usually indicate certain troubles in your application, as mentioned in the [Troubleshooting Guide](../troubleshooting/synchronization.md). However, if you want to disable this behavior (i.e. querying the app periodically), set the value to `0`.
