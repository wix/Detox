...
This _tracing_ view provides a visual, hierarchial representation of the of the various processes that took place during the execution of the testing session, over the execution's *time-line*. These processes appear as hierarchial _sections_ -- sometimes visually ordered in a parent-child way, depending on their formation time and context.
